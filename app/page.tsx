  ...
  return (
    <div className="min-h-screen w-full relative bg-white">
      <div className="relative z-10 min-h-screen w-full">
            ...
            <div className="text-center mb-8">
              <div className="inline-block mb-6">
                <span className="px-4 py-2 text-sm border border-gray-400 rounded-full bg-white/50 backdrop-blur-sm">
                  <GradientText
                    text="Build Your Family Legacy Today"
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                Easily build, view, and preserve your family tree for future
                generations. Connect with your roots and celebrate your
        ...
        <section
          id="features"
          className="py-20 px-6 lg:px-8 bg-gray-50 relative"
        >
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-20">
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">
                    Get a clear overview of all your key insights in one place
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">
                    Track your achievements with detailed, organized records
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">
                    Visualize your progress through analytic, easy-to-read
                    charts
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-10">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Visualize your family connections with beautiful,
                      easy-to-navigate tree diagrams.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Add and organize family members with detailed profiles and
                      photos.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Generate comprehensive reports and statistics about your
                      family history.
                    </p>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2 space-y-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Enter information about your family members.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Link relationships to build your family tree.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-6 lg:px-8 relative ">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Start documenting your family&apos;s unique journey today and
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-5 gap-8 mb-8">
              <div className="md:col-span-2">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Family Tree helps you build, visualize, and preserve your
                  family tree for future generations. Legacy tools designed to
                  help you connect with your roots and celebrate your
                  family&apos;s unique journey.
                </p>
              </div>
            ...
            <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-sm text-gray-600">
                &copy; 2025 Family Tree Management. All rights reserved.
              </p>
