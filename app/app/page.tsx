          ...
          <div className="grid md:grid-cols-3 gap-6 mb-20">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Visualize your progress through analytic, easy-to-read charts
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-5 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-gray-600 leading-relaxed">
                Family Tree helps you build, visualize, and preserve your family tree for future generations. Legacy tools designed to help you connect with your roots and celebrate your family&apos;s unique journey.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#features" className="text-gray-600 hover:text-gray-900 transition-colors">Home</a></li>
                <li><a href="#how-it-works" className="text-gray-600 hover:text-gray-900 transition-colors">Guide</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#features" className="text-gray-600 hover:text-gray-900 transition-colors">Member</a></li>
