								...
								>
									...
									<option value="partnership">
										<FormattedMessage
											...
											defaultMessage="Partnership Opportunities"
										/>
									</option>
									<option value="other">
					...
					<div>
						...
						<div className="space-y-6">
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-gray-600">
										<FormattedMessage
											id="contact.info.email.description"
											defaultMessage="Send us an email and we'll respond within 24 hours."
										/>
									</p>
							...
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-gray-600">
										<FormattedMessage
											id="contact.info.docs.description"
											defaultMessage="Find answers in our comprehensive documentation."
										/>
									</p>
						...
						<div className="mt-8 p-6 bg-gray-50 rounded-lg">
							...
							<p className="text-gray-600 text-sm">
								<FormattedMessage
									id="contact.info.hours.description"
									defaultMessage="Monday - Friday: 9:00 AM - 6:00 PM EST"
								/>
							</p>
							<p className="text-gray-600 text-sm">
