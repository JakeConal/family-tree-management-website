      ...
      <table className="w-full border-collapse text-left">
        <thead className="sticky top-0 bg-white z-10">
          <tr className="border-b border-gray-100">
            <th className="px-6 py-4 font-inter font-semibold text-[16px] text-black text-center w-20">
              No.
            </th>
            <th className="px-6 py-4 font-inter font-semibold text-[16px] text-black">
              Full Name
            </th>
            <th className="px-6 py-4 font-inter font-semibold text-[16px] text-black text-center">
              Birth Date
            </th>
            <th className="px-6 py-4 font-inter font-semibold text-[16px] text-black text-center">
              Gen. No.
            ...
            >
              ...
              <td className="px-6 py-4">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="font-playfair text-[16px] text-black">
                    {member.fullName}
                  </span>
                </div>
              </td>
