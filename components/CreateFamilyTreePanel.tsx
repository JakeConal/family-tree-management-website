      ...
      const response = await fetch("/api/family-trees", {
        ...
        body: JSON.stringify({
          ...
          rootPerson: {
            ...rootPersonData,
            profilePicture,
            placesOfOrigin: placesOfOrigin.filter(
              (p) => p.location && p.startDate
            ),
      ...
      <div className="p-4 lg:p-6 flex flex-col items-center relative">
        ...
        <form onSubmit={handleSubmit} className="px-4 lg:px-12 pb-12 flex-1">
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      required
                    >
                      <option value="" className="text-black/40">Select gender</option>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {placesOfOrigin.map((place, index) => (
                    <div
                      key={place.id}
                      className="bg-[#dbeafe] border border-black/50 rounded-[15px] p-4"
                    >
                      <div className="mb-3">
                        <label className="block text-[11px] font-bold mb-1 text-black">
                          {index === 0 ? "Current Origin *" : `Origin ${index + 1} *`}
                        </label>
                        <div className="relative">
                          <input
                            type="text"
                            placeholder="Choose origin"
                            className="w-full bg-[#eff6ff] border border-black/50 rounded-[30px] h-[33px] px-4 text-[11px] focus:outline-none text-black placeholder:text-black/40"
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input
                              ...
                              required
                            />
                            <Calendar className="absolute right-4 top-1/2 -translate-y-1/2 w-3 h-3 text-black pointer-events-none" />
                          </div>
                        </div>
                        <div>
                          <label className="block text-[11px] font-bold mb-1 text-black">
                ...
                {errors.placesOfOrigin && (
                  <p className="text-red-600 text-xs mt-1 font-bold">{errors.placesOfOrigin}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {occupations.map((occ, index) => (
                    ...
                    >
                      <div className="mb-3">
                        <label className="block text-[11px] font-bold mb-1 text-black">
                          {index === 0 ? "Current Job *" : `Job ${index + 1} *`}
                        </label>
                        <input
                          type="text"
                ...
                {errors.occupations && (
                  <p className="text-red-600 text-xs mt-1 font-bold">{errors.occupations}</p>
                )}
              </div>
          ...
          <div className="mt-12 space-y-6">
            ...
            <div className="bg-[#bfdbfe] border border-black/50 rounded-[10px] p-4 flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs leading-relaxed text-black font-medium">
                  Once a family member is added, their record becomes permanent
                  and cannot be deleted from the system. Please ensure all
            ...
            {generalError && (
              <p className="text-red-600 text-sm text-center font-bold">{generalError}</p>
            )}
