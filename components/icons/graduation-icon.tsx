...
export function GraduationIcon(props: SVGProps<SVGSVGElement>) {
	return (
		<svg viewBox="0 0 32 28" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" {...props}>
			<path d="M1.5 9 16 2l14.5 7L16 16 1.5 9Z" stroke="#1E1E1E" strokeWidth="2" strokeLinejoin="round" />
			<path
