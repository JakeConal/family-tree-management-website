import common from '@/locales/en/misc/common.json';
import modal from '@/locales/en/misc/modal.json';
...
import member from '@/locales/en/routes/member.json';
import memberList from '@/locales/en/routes/memberList.json';
import privacyPolicy from '@/locales/en/routes/privacy-policy.json';
import reports from '@/locales/en/routes/reports.json';
import settings from '@/locales/en/routes/settings.json';
