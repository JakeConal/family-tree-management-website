import common from '@/locales/vi/misc/common.json';
import modal from '@/locales/vi/misc/modal.json';
...
import member from '@/locales/vi/routes/member.json';
import memberList from '@/locales/vi/routes/memberList.json';
import privacyPolicy from '@/locales/vi/routes/privacy-policy.json';
import reports from '@/locales/vi/routes/reports.json';
import settings from '@/locales/vi/routes/settings.json';
